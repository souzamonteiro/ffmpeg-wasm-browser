...
# Script to generate all the icons for the FFmpeg.wasm PWA

echo "Generating icons for the FFmpeg.wasm PWA..."
...
{
  "name": "FFmpeg.wasm Console",
  "short_name": "FFmpegConsole",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "A web-based console for FFmpeg.wasm - run FFmpeg commands directly in your browser.",
  "icons": [
    {
